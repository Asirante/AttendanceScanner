...
**exp07 (ArcFace 그리드)** — margin 4종 × scale 3종 = 12조합을 탐색한 결과, 최고는 **margin 0.5 / scale 16에서 test 0.9723**으로 전체 최고 정확도였습니다. 다만 12조합 모두 0.9668~0.9723에 몰려(편차 0.55%p), 마진·스케일 선택에 성능이 크게 좌우되지 않았습니다. ArcFace 논문 권장값(margin 0.5) 부근이 가장 안정적이었습니다.
